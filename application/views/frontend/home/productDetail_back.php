    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="Gallery" href="<?=base_url('assets/frontend/images/products/p8.jpg');?>">
                    <img class="img-responsive" alt="" src="<?=base_url('assets/frontend/images/blank.gif');?>" data-echo="<?=base_url('assets/frontend/images/products/p8.jpg');?>" />
                </a>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?=base_url('assets/images/blank.gif');?>" data-echo="<?=base_url('assets/frontend/images/products/p2.jpg');?>" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="<?=base_url('assets/frontend/images/blank.gif');?>" data-echo="<?=base_url('assets/frontend/images/products/p6.jpg');?>" alt=""></a>
			</div><!-- /.image -->			
