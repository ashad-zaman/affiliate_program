  ...
  <div class="container">
      ...
      <div class="row"> 
       ...
       <?php
          ...
          // exit;
          if( $this->uri->segment(1) == 'login' ||  $this->uri->segment(1) == 'get-login' ): else:
       ?> 
      <!-- ============================================== SIDEBAR ============================================== -->
     <?php /* <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="sidebar-widget outer-bottom-small wow fadeInUp">
          <div class="alignleft">
             <script type="text/javascript">
                ...
                amzn_assoc_width = "222";
                amzn_assoc_height = "600";
                amzn_assoc_tracking_id = "bestmultit06a-20";
                amzn_assoc_linkid = "1a2a9874e21df802f407dfba7a3d7db8";
             </script>
        ...
        <div class="sidebar-widget outer-bottom-small wow fadeInUp">
          <div class="alignleft">
           <script type="text/javascript">
              ...
              amzn_assoc_p = "14";
              amzn_assoc_isresponsive = "false";
              amzn_assoc_banner_id = "19Y66BHX7TJCNGE7KN02";
              amzn_assoc_width = "160";
              amzn_assoc_height = "600";
              amzn_assoc_tracking_id = "bestmultit06a-20";
              amzn_assoc_linkid = "ab4484a89693b799836b786e4c9257c2";
           </script>
           <script src="//z-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&Operation=GetScript&ID=OneJS&WS=1"></script>
          </div>
        </div>
